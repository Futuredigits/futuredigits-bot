translations = {
    "en": {
        "welcome": (
            ...
            "You will receive your *Life Path Number*."
         ),
    ...
    "lt": {
        "welcome": (
            ...
            "Jūs gausite savo *Gyvenimo Kelio Skaičių*."
        ),
    ...
    "ru": {
        "welcome": (
            ...
            "Вы получите своё *Число Жизненного Пути*."
        ),
        ...
        "birthday_description_14": "Вы гибки, энергичны и постоянно развиваетесь. С вами жизнь полна движения.",
        ...
        "birthday_description_29": "Вы идеалист, духовный проводник. Стремитесь служить высшему призванию.",
        "birthday_description_30": "Вы радостны, выразительны и творчески одарены. Несёте свет через слова и искусство.",
